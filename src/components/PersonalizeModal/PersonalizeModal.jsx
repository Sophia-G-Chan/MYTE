...
function PersonalizeModal() {
    ...
    return (
        <div className='w-full '>
            <button className='mr-4 h-full justify-center items-center w-16 tablet:w-full flex bg-teal-100 tablet:my-4 custom-aside__button personalize-btn tablet:justify-start'
                onClick={openModal}>
